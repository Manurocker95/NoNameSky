	...
	public void loadScene(int id) throws ParserConfigurationException, SAXException, IOException, InterruptedException, FontFormatException
	{
		...
		switch (id)
		{
			case 1: //portada
				...
				if (music != null)
					music.stop();
				music = new Util_Music("Start.wav");			//Reproducimos la música de fondo
			...
			case 2: //Juego
				music.stop();
				music = new Util_Music("music.wav");	//Reproducimos la música de fondo
				music.loop();	
				p.setFoc(false);
				if (en != null)
					en.setFoc(false);
			...
			case 3: //Final = GameOver
				music.stop();
				music = new Util_Music("Game Over.wav");	//Reproducimos la música de fondo
				music.loop();
